...
/******** OWNER NUMBER**********/
const ownerNumber = ["13132900007@s.whatsapp.net","12264440009@s.whatsapp.net"] 
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('qr already scan.subscribe','white'),color('YOU','red'),color('TUBE','white'),color('WHIZQIDS','yellow'))
})
           ...
           return false
			...
			switch(command) {
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					client.sendMessage(from, vintage, image, {caption: 'nih gan ${vin}', quoted: mek})
                ...
                case '1cak':
				    try {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'ni gan'})
					} catch (e) {
                ...
                case 'slap':
                    ...
                    if (isLimit(sender)) return reply(ind.limitend(pusname))
					const slap =['anjing','babi lu','anak anjing','udah tolol nub Lagi','muka lo kek monyet','udah jomblo sendirian lagi dirumah tolol','so so an mau punya pacar muka aja kek monyet lepass dari kandang','ganteng doang di toxic aja dibilang baperan','pantek kau','bangsat kau','gue gampar kalian nangis kau','memek lu semua','lihat anak anjing lagi baca','ganteng doang jemput cewe dipanggang','kamu cantik beb bullshit anjing cowo buaya','anak dajjal','puki lu','anjing ngajak gelud','sama hantu takut cupu ngentod','cupu cupu aja gausah bacot','kontol lu semua','bocah lu semua kontol','3 Hari Lagi']
